...
const PaymentDetailsPage = (props) => {
	return (
		<div className="page-component page-component--payment-details">
			...
			При доставке товара почтой. Оплата производится в почтовом отделении при получении товара. Обратите внимание, что почта взимает комиссию за перевод денежных средств в размере около 3,6% от суммы перевода.
			</p>
